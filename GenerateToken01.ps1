...
$clientId = "x-b18e-6db395c662aa"
$ClientSecret = 'xWElQANwX~m4R7-MaGcr1'
$tenantId = 'x-b5bd-f5b83846ddee'
$redirectUri = "https://login.microsoftonline.com/common/oauth2/nativeclient"

# Scope - Needs to include all permisions required separated with a space
$scope = "Sites.FullControl.All" # This is just an example set of permissions
